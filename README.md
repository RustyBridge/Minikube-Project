...
Being the stateful component of the application, it required persistent storage, which was provisioned locally using https://github.com/rancher/local-path-provisioner \
...
The communication with the DB is established using https://github.com/datastax/python-driver \
